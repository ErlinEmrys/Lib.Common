...
namespace Erlin.Lib.Common.Time
{
    ...
    {
        /// <summary>
        /// Full formated DateTime (2017.05.30 23:58:33)
        /// </summary>
        public const string FORMAT_FULL = "yyyy.MM.dd HH:mm:ss";

        /// <summary>
        /// Full formated Date (2017.05.30)
        /// </summary>
        public const string FORMAT_DATE = "yyyy.MM.dd";

        /// <summary>
        /// Time formated without ticks (23:58:33)
        /// </summary>
        public const string FORMAT_TIME = "HH:mm:ss";

        /// <summary>
        /// Full formated Time (23:58:33:4478)
        /// </summary>
        ...
        public static DateTime Now
        {
            get
            {
                return EnvironmentHelper.DateTime.Now;
            }
        }
    }
}