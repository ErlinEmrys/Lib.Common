...
{
	private List<T> ReadWriteListImpl<T>(
		...
		string? argumentName = null )
	{
		...
		return ReadWriteListNImpl( value, itemDeSerialization, isPrimitive, argumentName )
			?? throw new DeSerializeException( "Reading NULL value on expected instance!" );
	}

	private List<T>? ReadWriteListNImpl<T>(
		List<T>? value, Func<DeSerializeContext<T>, T> itemDeSerialization, bool isPrimitive = false,
		[CallerArgumentExpression( nameof( value ) )]
		string? argumentName = null )
	{
		...
		if( IsWrite )
		{
			...
			if( value != null )
			{
				for( int i = 0; i < count; i++ )
				{
					T item = value[ i ];
					itemDeSerialization(
						new DeSerializeContext<T>( this, item, i, item?.GetType() ?? typeof( T ), null ) );
				}
	...
	public List<T> ReadWriteList<T>(
		List<T> value, Func<DeSerializeContext<T>, T> itemDeSerialization,
		bool isPrimitive = false,
		[CallerArgumentExpression( nameof( value ) )]
		string? argumentName = null )
	{
		return ReadWriteListImpl(
			value,
			isPrimitive ? itemDeSerialization : c => ReadWrite(
				c.GetValue(), itemDeSerialization, c.ArgumentName, c.ValueIndex ),
			isPrimitive, argumentName );
	}

	public List<T>? ReadWriteListN<T>(
		List<T>? value, Func<DeSerializeContext<T>, T> itemDeSerialization,
		bool isPrimitive = false,
		[CallerArgumentExpression( nameof( value ) )]
		string? argumentName = null )
	{
		return ReadWriteListNImpl(
			value,
			isPrimitive ? itemDeSerialization : c => ReadWrite(
				c.GetValue(), itemDeSerialization, c.ArgumentName, c.ValueIndex ),
			isPrimitive, argumentName );
	...
	public List<string> ReadWriteStringList(
	...
	public List<string>? ReadWriteStringListN(
		List<string>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<string?> ReadWriteStringNList(
		List<string?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<string?>? ReadWriteStringNListN(
		List<string?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<sbyte> ReadWriteSByteList(
	...
	public List<sbyte>? ReadWriteSByteListN(
		List<sbyte>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<sbyte?> ReadWriteSByteNList(
		List<sbyte?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<sbyte?>? ReadWriteSByteNListN(
		List<sbyte?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<byte> ReadWriteByteList(
	...
	public List<byte>? ReadWriteByteListN(
		List<byte>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<byte?> ReadWriteByteNList(
		List<byte?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<byte?>? ReadWriteByteNListN(
		List<byte?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<short> ReadWriteInt16List(
	...
	public List<short>? ReadWriteInt16ListN(
		List<short>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<short?> ReadWriteInt16NList(
		List<short?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<short?>? ReadWriteInt16NListN(
		List<short?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<ushort> ReadWriteUInt16List(
	...
	public List<ushort>? ReadWriteUInt16ListN(
		List<ushort>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<ushort?> ReadWriteUInt16NList(
		List<ushort?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<ushort?>? ReadWriteUInt16NListN(
		List<ushort?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<int> ReadWriteInt32List(
	...
	public List<int>? ReadWriteInt32ListN(
		List<int>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<int?> ReadWriteInt32NList(
		List<int?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<int?>? ReadWriteInt32NListN(
		List<int?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<uint> ReadWriteUInt32List(
	...
	public List<uint>? ReadWriteUInt32ListN(
		List<uint>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<uint?> ReadWriteUInt32NList(
		List<uint?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<uint?>? ReadWriteUInt32NListN(
		List<uint?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<long> ReadWriteInt64List(
	...
	public List<long>? ReadWriteInt64ListN(
		List<long>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<long?> ReadWriteInt64NList(
		List<long?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<long?>? ReadWriteInt64NListN(
		List<long?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<ulong> ReadWriteUInt64List(
	...
	public List<ulong>? ReadWriteUInt64ListN(
		List<ulong>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<ulong?> ReadWriteUInt64NList(
		List<ulong?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<ulong?>? ReadWriteUInt64NListN(
		List<ulong?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<float> ReadWriteFloatList(
	...
	public List<float>? ReadWriteFloatListN(
		List<float>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<float?> ReadWriteFloatNList(
		List<float?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<float?>? ReadWriteFloatNListN(
		List<float?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<double> ReadWriteDoubleList(
	...
	public List<double>? ReadWriteDoubleListN(
		List<double>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<double?> ReadWriteDoubleNList(
		List<double?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<double?>? ReadWriteDoubleNListN(
		List<double?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<decimal> ReadWriteDecimalList(
	...
	public List<decimal>? ReadWriteDecimalListN(
		List<decimal>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<decimal?> ReadWriteDecimalNList(
		List<decimal?> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
	...
	public List<decimal?>? ReadWriteDecimalNListN(
		List<decimal?>? value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
	{
