...
{
	private HashSet< T > ReadWriteHashSetImpl< T >( HashSet< T > value, Func< DeSerializeContext< T >, T > itemDeSerialization, bool isPrimitive = false, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
		...
		return ReadWriteHashSetNImpl( value, itemDeSerialization, isPrimitive, argumentName ) ?? throw new DeSerializeException( "Reading NULL value on expected instance!" );
	}

	private HashSet< T >? ReadWriteHashSetNImpl< T >( HashSet< T >? value, Func< DeSerializeContext< T >, T > itemDeSerialization, bool isPrimitive = false, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
		int count;
		if( IsWrite )
		{
			...
			if( value != null )
			{
				...
				{
					itemDeSerialization( new DeSerializeContext< T >( this, fValue, i, fValue?.GetType() ?? typeof( T ), null ) );
		...
		if( count >= 0 )
		{
			...
			{
				T item = itemDeSerialization( new DeSerializeContext< T >( this, default, i, valueType, argumentName ) );

				if( !value.Add( item ) )
				{
					throw new DeSerializeException( $"Attempt to add existing value {item} to HashSet during deserialization! " );
				}
			}
	...
	public HashSet< T > ReadWriteHashSet< T >( HashSet< T > value, Func< DeSerializeContext< T >, T > itemDeSerialization, bool isPrimitive = false, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
		return ReadWriteHashSetImpl( value, isPrimitive ? itemDeSerialization : c => ReadWrite( c.GetValue(), itemDeSerialization, c.ArgumentName, c.ValueIndex ), isPrimitive, argumentName );
	}

	public HashSet< T >? ReadWriteHashSetN< T >( HashSet< T >? value, Func< DeSerializeContext< T >, T > itemDeSerialization, bool isPrimitive = false, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
		return ReadWriteHashSetNImpl( value, isPrimitive ? itemDeSerialization : c => ReadWrite( c.GetValue(), itemDeSerialization, c.ArgumentName, c.ValueIndex ), isPrimitive, argumentName );
	}
	...
	public HashSet< T > ReadWriteHashSet< T >( HashSet< T > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
		where T : IDeSerializable
	{
	...
	public HashSet< T >? ReadWriteHashSetN< T >( HashSet< T >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
		where T : IDeSerializable
	{
	...
	public HashSet< string > ReadWriteStringHashSet( HashSet< string > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< string >? ReadWriteStringHashSetN( HashSet< string >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< string? > ReadWriteStringNHashSet( HashSet< string? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< string? >? ReadWriteStringNHashSetN( HashSet< string? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< sbyte > ReadWriteSByteHashSet( HashSet< sbyte > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< sbyte >? ReadWriteSByteHashSetN( HashSet< sbyte >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< sbyte? > ReadWriteSByteNHashSet( HashSet< sbyte? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< sbyte? >? ReadWriteSByteNHashSetN( HashSet< sbyte? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< byte > ReadWriteByteHashSet( HashSet< byte > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< byte >? ReadWriteByteHashSetN( HashSet< byte >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< byte? > ReadWriteByteNHashSet( HashSet< byte? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< byte? >? ReadWriteByteNHashSetN( HashSet< byte? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< short > ReadWriteInt16HashSet( HashSet< short > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< short >? ReadWriteInt16HashSetN( HashSet< short >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< short? > ReadWriteInt16NHashSet( HashSet< short? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< short? >? ReadWriteInt16NHashSetN( HashSet< short? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< ushort > ReadWriteUInt16HashSet( HashSet< ushort > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< ushort >? ReadWriteUInt16HashSetN( HashSet< ushort >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< ushort? > ReadWriteUInt16NHashSet( HashSet< ushort? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< ushort? >? ReadWriteUInt16NHashSetN( HashSet< ushort? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< int > ReadWriteInt32HashSet( HashSet< int > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< int >? ReadWriteInt32HashSetN( HashSet< int >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< int? > ReadWriteInt32NHashSet( HashSet< int? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< int? >? ReadWriteInt32NHashSetN( HashSet< int? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< uint > ReadWriteUInt32HashSet( HashSet< uint > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< uint >? ReadWriteUInt32HashSetN( HashSet< uint >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< uint? > ReadWriteUInt32NHashSet( HashSet< uint? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< uint? >? ReadWriteUInt32NHashSetN( HashSet< uint? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< long > ReadWriteInt64HashSet( HashSet< long > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< long >? ReadWriteInt64HashSetN( HashSet< long >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< long? > ReadWriteInt64NHashSet( HashSet< long? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< long? >? ReadWriteInt64NHashSetN( HashSet< long? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< ulong > ReadWriteUInt64HashSet( HashSet< ulong > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< ulong >? ReadWriteUInt64HashSetN( HashSet< ulong >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< ulong? > ReadWriteUInt64NHashSet( HashSet< ulong? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< ulong? >? ReadWriteUInt64NHashSetN( HashSet< ulong? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< float > ReadWriteFloatHashSet( HashSet< float > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< float >? ReadWriteFloatHashSetN( HashSet< float >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< float? > ReadWriteFloatNHashSet( HashSet< float? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< float? >? ReadWriteFloatNHashSetN( HashSet< float? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< double > ReadWriteDoubleHashSet( HashSet< double > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< double >? ReadWriteDoubleHashSetN( HashSet< double >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< double? > ReadWriteDoubleNHashSet( HashSet< double? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< double? >? ReadWriteDoubleNHashSetN( HashSet< double? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< decimal > ReadWriteDecimalHashSet( HashSet< decimal > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< decimal >? ReadWriteDecimalHashSetN( HashSet< decimal >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< decimal? > ReadWriteDecimalNHashSet( HashSet< decimal? > value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
	...
	public HashSet< decimal? >? ReadWriteDecimalNHashSetN( HashSet< decimal? >? value, [ CallerArgumentExpression( nameof( value ) ) ]string? argumentName = null )
	{
