...
public interface IDeSerializer : IDisposable
{
	...
	DateTimeOffset ReadWriteDateTimeOffset(
	...
	DateTimeOffset? ReadWriteDateTimeOffsetN(
	...
	T ReadWrite<T>(
		T value,
		Func<DeSerializeContext<T>, T> objectDeSerialization,
		[CallerArgumentExpression( nameof( value ) )]
	...
	List<T> ReadWriteList<T>(
		List<T> value, [CallerArgumentExpression( nameof( value ) )]string? argumentName = null )
		where T : IDeSerializable;

	List<T> ReadWriteList<T>(
		List<T> value, Func<DeSerializeContext<T>, T> itemDeSerialization, bool isPrimitive = false,
		[CallerArgumentExpression( nameof( value ) )]
		string? argumentName = null );
	...
	Dictionary<TKey, TValue> ReadWriteDic<TKey, TValue>(
	...
	Dictionary<TKey, TValue>? ReadWriteDicN<TKey, TValue>(
		Dictionary<TKey, TValue>? value, Func<DeSerializeContext<TKey>, TKey> keyDeSerialization,
		Func<DeSerializeContext<TValue>, TValue> valueDeSerialization,
		[CallerArgumentExpression( nameof( value ) )]
		string? argumentName = null )
